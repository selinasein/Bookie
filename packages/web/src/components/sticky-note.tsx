...
export default function StickyNote({
  ...
  return (
    <div
      className="w-full h-full md:w-64 md:h-80 rounded-xl shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] text-black/70 bg-slate-300 p-3"
      key={i}
    >
      <div>
        ...
        <div className="text-xs h-48">{note.content}</div>
      </div>
      {token !== "" && (
        <div className="flex items-end justify-end gap-1 p-3">
